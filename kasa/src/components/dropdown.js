...
function Dropdown(props) {
    ...
    return (
        <div className={`mx-6 h-auto relative lg:mx-52 ${containerClass}`}>
            <div onClick={_.throttle(displayDropdownContent, 1000)} className="relative z-20 bg-primary rounded-md flex justify-between items-center h-8 lg:h-12">
            ...
            <div className={`px-3 lg:px-6 pt-8 pb-4 bg-gray300 rounded-b-md w-full h-auto relative -top-4 z-10 ${dropdownClass}`}>
